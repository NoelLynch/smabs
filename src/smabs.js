...
var AssembleFilesPhase, CoffeeScriptCompilePhase, FileSys, LessCompilePhase, MinifyJSPhase, SMABSFileSys, Templates, args, doGetTemplate, doHelp, doSaveTemplate, getTargetPhases, loadBuildConf, processArgs, run;
    ...
    if (conf.phases[phase] != null) {
      ...
      switch (p.type) {
        ...
        case "minifyJS":
          ...
          break;
        case "lessCompile":
          LessCompilePhase.doPhase(p, args);
      }
